// Package setu 基于 https://api.lolicon.app 随机图片
package setu
...
import (
	...
	control1 "github.com/FloatTech/zbputils/control"
	"github.com/FloatTech/zbputils/ctxext"
	lolipool "github.com/FloatTech/zbputils/img/pool"
...
func init() {
	en := control1.Register("lolicon", &control1.Options{
		DisableOnDefault: false,
		Help: "lolicon\n" +
			"- 来份萝莉\n" +
			"- 设置随机图片地址[http...]",
	}).ApplySingle(ctxext.DefaultSingle)
	en.OnFullMatch("来份萝莉", zero.AdminPermission).SetBlock(true).
